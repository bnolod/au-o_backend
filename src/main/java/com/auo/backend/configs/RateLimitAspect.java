...
import com.auo.backend.exceptions.RateLimitException;
...
public class RateLimitAspect {
    ...
    @Value("${APP_RATE_LIMIT:#{20}}")
    private int rateLimit;

    @Value("${APP_RATE_DURATIONINMS:#{200}}")
     ...
     */
    @Before("@annotation(com.auo.backend.configs.RateLimitProtection)")
